...
let AddContactComponent = class AddContactComponent {
    constructor(dataService, activateRouter, builder, router) {
...
let ContactDetailComponent = class ContactDetailComponent {
    constructor(dialog, contactService, activedRouter) {
        this.dialog = dialog;
        this.contactService = contactService;
        this.activedRouter = activedRouter;
    }
    ngOnInit() {
        this.activedRouter.params.subscribe(param => ((this.contactService.findContactById(param['id']).subscribe(p => (this.contact = p)),
            this.id = param['id'])));
    }
    openDialog() {
...
DeleteDialogBoxComponent.ctorParameters = () => [
